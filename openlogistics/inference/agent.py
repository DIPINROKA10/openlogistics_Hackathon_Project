...
async def run_inference(
    ...
    print(f"Initial state: Time {state.time}")
    ...
    for step in range(max_steps):
        ...
        actions = await agent.decide_actions(state, task_id, task_descriptions.get(task_id, ""))
    ...
    print(f"Delivery Rate: {final_score['delivery_rate']:.2%}")
    print(f"Cost Efficiency: {final_score['cost_efficiency']:.2%}")
    print(f"Completed Orders: {final_score['completed_orders']}/{final_score['total_orders']}")
    print(f"Failed Orders: {final_score['failed_orders']}")
    print(f"Total Delivered: {final_score['total_delivered']}/{final_score['total_items']}")
    print(f"Total Cost: {final_score['total_cost']:.2f}")
    print(f"Episode Time: {final_score['episodes_time']}")
